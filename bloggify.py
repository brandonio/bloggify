...
if not skip:
	...
	fourohfour.write("\n")
	fourohfour.write("\t<a id='prev' class='bar' href='http://brandonb.me/blog/" + binnum + "'></a>\n")
	fourohfour.write("\t<a id='iprev' class='bar' href='http://brandonb.me/blog/" + binnum + "'></a>\n")
	fourohfour.write("\n")
	fourohfour.write("\t<a id='next' class='bar' href='http://brandonb.me/blog'></a>\n")
	fourohfour.write("\t<a id='inext' class='bar' href='http://brandonb.me/blog'></a>\n")
	...
	for line in index:
		if count != stop:
			...
			towrite.append("\t\t\t<a class='num' href='http://brandonb.me/blog/" + binnum + "'>" + ze + "</a>\n")
			towrite.append("\t\t\t<a class='name' href='http://brandonb.me/blog/" + binnum + "'>" + og + "</a>\n")
			towrite.append("\t\t</div>\n")
			towrite.append(line)
		count += 1
	index.close()
